...
class StoreConcretePouringRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'pouring_datetime.after' => 'The pouring date and time must be in the future.',
            'estimated_volume.max' => 'The estimated volume cannot exceed 9999.99 cubic meters.',
        ];
    }

...
{{-- ── Role-specific Action Form ── --}}
            @if($role === 'site_inspector')
                <div class="wrd-card" style="border-top: 3px solid #60a5fa;">
                    <div class="wrd-card-head">
                        <div class="wrd-card-head-icon blue"><i class="fas fa-hard-hat" style="color:#60a5fa;"></i></div>
            ...
            @elseif($role === 'surveyor')
                <div class="wrd-card" style="border-top: 3px solid #c084fc;">
                    <div class="wrd-card-head">
                        <div class="wrd-card-head-icon purple"><i class="fas fa-drafting-compass" style="color:#c084fc;"></i></div>
            ...
            @elseif($role === 'resident_engineer')
                <div class="wrd-card" style="border-top: 3px solid #34d399;">
                    <div class="wrd-card-head">
                        <div class="wrd-card-head-icon green"><i class="fas fa-hard-hat" style="color:#34d399;"></i></div>
            ...
            @elseif($role === 'provincial_engineer')
                <div class="wrd-card" style="border-top: 3px solid #f97316;">
                    <div class="wrd-card-head">
                        <div class="wrd-card-head-icon orange"><i class="fas fa-user-tie" style="color:#f97316;"></i></div>

...
@section('content')
    ...
    <div class="mo-breadcrumb">
        <a href="{{ route('reviewer.memos.index') }}"><i class="fas fa-envelope mr-1"></i>My Memos</a>
        <span class="sep">/</span>
        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="mo-card">
                ...
                <div class="mo-action-bar">
                    <a href="{{ route('reviewer.memos.index') }}" class="mo-btn mo-btn-secondary">
...
<script>
    ...
    @if ($recipient && !$recipient->read_at)
        fetch('{{ route('reviewer.memos.mark-read', $memo) }}', {
            method: 'POST',
            headers: {

...
<style>
    ...
    .wr-panel-title {
        ...
        color: var(--wr-text);
        letter-spacing: -0.3px; margin-bottom: 4px; line-height: 1.3;
    }
    ...
    .wr-err-msg { font-size: 11px; color: var(--wr-error); display: none; align-items: center; gap: 4px; }
    .wr-err-msg.show { display: flex; }

    .wr-status-options { display: grid; grid-template-columns: repeat(auto-fill, minmax(130px, 1fr)); gap: 8px; }
    .wr-status-opt {
        display: flex; align-items: center; gap: 8px;
        padding: 10px 12px;
        border: 1.5px solid var(--wr-border);
    ...
    .wr-btn-ghost { background: transparent; border: 1.5px solid var(--wr-border); color: var(--wr-muted); }
    ...
    .wr-btn-success { background: var(--wr-accent2); color: #0f1117; box-shadow: 0 4px 18px rgba(0,212,170,0.3); font-weight: 800; }
    ...
    .wr-summary-section { background: var(--wr-surface2); border: 1px solid var(--wr-border); border-radius: var(--wr-radius-sm); overflow: hidden; }
    .wr-summary-head {
        display: flex; align-items: center; gap: 8px;
        padding: 10px 16px;
        ...
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-size: 12px; font-weight: 700; color: var(--wr-label);
    }
    html:not(.dark) .wr-summary-head { background: rgba(0,0,0,0.02); }
    .wr-summary-rows { padding: 12px 16px; display: grid; gap: 10px; }
    .wr-summary-row { display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; }
    .wr-summary-key { font-size: 12px; font-weight: 600; color: var(--wr-muted); min-width: 130px; font-family: 'Plus Jakarta Sans', sans-serif; }

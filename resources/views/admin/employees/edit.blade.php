...
@section('content')
    ...
    <div class="mb-8 max-w-3xl mx-auto">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-2">Update employee information</p>
    </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name" required
                               value="{{ old('first_name', $employee->first_name) }}" placeholder="e.g., Juan"
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" id="last_name" required
                               value="{{ old('last_name', $employee->last_name) }}" placeholder="e.g., Dela Cruz"
                    ...
                    <div>
                        ...
                        <input type="text" name="middle_name" id="middle_name"
                               value="{{ old('middle_name', $employee->middle_name) }}" placeholder="e.g., Santos"
                    ...
                    <div>
                        ...
                        <input type="email" name="email_address" id="email_address"
                               value="{{ old('email_address', $employee->email_address) }}" placeholder="e.g., juan@example.com"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="height_cm" id="height_cm"
                               value="{{ old('height_cm', $employee->height_cm) }}" placeholder="e.g., 165.00"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="weight_kg" id="weight_kg"
                               value="{{ old('weight_kg', $employee->weight_kg) }}" placeholder="e.g., 60.00"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="home_address" id="home_address" rows="2"
                                  ...
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition @error('home_address') border-red-500 @enderror">{{ old('home_address', $employee->home_address) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" id="phone_number"
                               value="{{ old('phone_number', $employee->phone_number) }}" placeholder="09xxxxxxxxx"
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_no" id="emergency_contact_no"
                               value="{{ old('emergency_contact_no', $employee->emergency_contact_no) }}" placeholder="09xxxxxxxxx"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="id_number" id="id_number" required
                               value="{{ old('id_number', $employee->id_number) }}" placeholder="PDS-xxxxxxxxx"
                    ...
                    <div>
                        ...
                        <input type="text" name="tin" id="tin"
                               value="{{ old('tin', $employee->tin) }}" placeholder="xxx-xxx-xxx"
                    ...
                    <div>
                        ...
                        <input type="text" name="pagibig_no" id="pagibig_no"
                               value="{{ old('pagibig_no', $employee->pagibig_no) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="philhealth" id="philhealth"
                               value="{{ old('philhealth', $employee->philhealth) }}" placeholder="15-000000000-6"
                    ...
                    <div>
                        ...
                        <input type="text" name="gsis_no" id="gsis_no"
                               value="{{ old('gsis_no', $employee->gsis_no) }}" placeholder="10-digit number"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="hmo_organization" id="hmo_organization"
                               value="{{ old('hmo_organization', $employee->hmo_organization) }}" placeholder="e.g., 1 Health Coop - FICCO"
                    ...
                    <div>
                        ...
                        <input type="text" name="hmo_number" id="hmo_number"
                               value="{{ old('hmo_number', $employee->hmo_number) }}"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="eligibility" id="eligibility"
                               value="{{ old('eligibility', $employee->eligibility) }}" placeholder="e.g., CSC, TESDA NC II, PRC"
                    ...
                    <div>
                        ...
                        <input type="text" name="licence_number" id="licence_number"
                               value="{{ old('licence_number', $employee->licence_number) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="office" id="office"
                               value="{{ old('office', $employee->office) }}" placeholder="e.g., District Engineering Office"

...
<style>
    ...
    .wr-progress-inner { display: flex; align-items: center; min-width: 560px; }
    .wr-step-item {
    ...
    .wr-step-item:not(:last-child)::after {
        ...
        height: 1px; background: var(--wr-border);
    ...
    .wr-step-num {
        ...
        color: var(--wr-muted); background: var(--wr-bg);
        transition: all 0.3s; flex-shrink: 0;
        font-family: 'Plus Jakarta Sans', sans-serif;
        position: relative; z-index: 1;
    }
    .wr-step-item.active .wr-step-num {
        background: var(--wr-accent); border-color: var(--wr-accent);
        color: white; box-shadow: 0 0 16px rgba(79,141,255,0.4);
    }
    .wr-step-item.done .wr-step-num {
        background: var(--wr-accent2); border-color: var(--wr-accent2); color: white;
    }
    .wr-step-label {
        font-size: 11px; font-weight: 500; color: var(--wr-muted);
    ...
    @media (max-width: 600px) { .wr-step-label { display: none; } }
    ...
    .wr-panel-tag {
        ...
        color: var(--wr-accent); background: rgba(79,141,255,0.1);
        border: 1px solid rgba(79,141,255,0.25);
        padding: 5px 14px; border-radius: 20px; margin-bottom: 12px;
        font-family: 'Plus Jakarta Sans', sans-serif;
    }
    html:not(.dark) .wr-panel-tag { background: rgba(37,99,235,0.08); border-color: rgba(37,99,235,0.2); }
    .wr-panel-tag.green { color: var(--wr-accent2); background: rgba(0,212,170,0.1); border-color: rgba(0,212,170,0.25); }
    html:not(.dark) .wr-panel-tag.green { background: rgba(5,150,105,0.08); border-color: rgba(5,150,105,0.2); }
    .wr-panel-tag.orange { color: #f59e0b; background: rgba(245,158,11,0.1); border-color: rgba(245,158,11,0.25); }
    html:not(.dark) .wr-panel-tag.orange { color: #d97706; background: rgba(217,119,6,0.08); border-color: rgba(217,119,6,0.2); }
    .wr-panel-tag.purple { color: #a78bfa; background: rgba(167,139,250,0.1); border-color: rgba(167,139,250,0.25); }
    html:not(.dark) .wr-panel-tag.purple { color: #7c3aed; background: rgba(124,58,237,0.08); border-color: rgba(124,58,237,0.2); }

    .wr-panel-title {
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-size: 22px; font-weight: 700;
        color: var(--wr-text); letter-spacing: -0.3px;
        margin-bottom: 4px; line-height: 1.3;
    }
    .wr-panel-sub { font-size: 14px; color: var(--wr-muted); margin-bottom: 1.75rem; line-height: 1.6; }
    ...
    .wr-icon {
        ...
        transform: translateY(-50%);
        color: var(--wr-muted); font-style: normal;
    ...
    .wr-input-wrap:focus-within textarea {
        border-color: var(--wr-accent); background: var(--wr-focus-bg);
    ...
    .wr-input-wrap input[readonly] { color: var(--wr-muted); cursor: not-allowed; border-style: dashed; }
    ...
    .wr-readonly-badge {
        ...
        color: var(--wr-muted); background: var(--wr-surface);
        border: 1px solid var(--wr-border); border-radius: 4px; padding: 2px 7px;
        font-family: 'Plus Jakarta Sans', sans-serif;
    }
    ...
    /* ── Section Blocks (for grouped reviewer sections) ── */
    .wr-section-block {
        padding: 20px;
        border-radius: var(--wr-radius-sm);
        border: 1px solid var(--wr-border);
    ...
    .wr-section-gap { height: 16px; }

    /* ── Signature Preview Box ── */
    .wr-sig-preview-box {
        min-height: 80px;
        border: 1.5px dashed var(--wr-border);
        border-radius: var(--wr-radius-sm);
        background: var(--wr-surface);
        display: flex; align-items: center; justify-content: center;
        overflow: hidden;
    ...
    .wr-sig-preview-box.has-sig { border-style: solid; border-color: var(--wr-accent2); }
    .wr-sig-img {
    ...
    .wr-suggestion-item:last-child { border-bottom: none; }
    .wr-suggestion-item:hover { background: var(--wr-focus-bg); }
    .wr-suggestion-name {
        font-size: 13px; font-weight: 600; color: var(--wr-text);
        font-family: 'Plus Jakarta Sans', sans-serif;
    }
    .wr-suggestion-meta { font-size: 11px; color: var(--wr-muted); }
    .wr-suggestion-avatar {
    ...
    .wr-btn {
        ...
        padding: 11px 22px; border: none; border-radius: var(--wr-radius-sm);
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-size: 13px; font-weight: 700;
    ...
    .wr-btn-primary { background: var(--wr-accent); color: white; box-shadow: 0 4px 18px rgba(79,141,255,0.3); }
    .wr-btn-primary:hover { filter: brightness(1.1); transform: translateY(-1px); }
    .wr-btn-success {
        background: var(--wr-accent2); color: #0f1117;
        box-shadow: 0 4px 18px rgba(0,212,170,0.3); font-weight: 800;
    }

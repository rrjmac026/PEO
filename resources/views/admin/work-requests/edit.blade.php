        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.work-requests.update', $workRequest) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           name="requested_by" 
                                           id="requested_by"
                                           value="{{ old('requested_by', $workRequest->requested_by) }}"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            <strong>{{ __('Note:') }}</strong> {{ __('Only work requests with "Draft" or "Submitted" status can be edited.') }}
                        </p>
                    </div>
                </div>
            </div>

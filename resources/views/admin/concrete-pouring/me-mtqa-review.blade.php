    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                ME/MTQA Review - {{ $concretePouring->project_name }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">ME/MTQA Review Form</h3>
                    
                    <form action="{{ route('admin.concrete-pouring.store-me-mtqa-review', $concretePouring) }}" method="POST" class="space-y-6">
                        @csrf

                        <div>
                            <label for="me_mtqa_remarks" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Review Remarks
                            </label>
                            <textarea id="me_mtqa_remarks" 
                                      name="me_mtqa_remarks" 
                                      rows="8"
                                      placeholder="Enter your remarks or findings from the ME/MTQA review..."
                                      class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-orange-500 dark:focus:border-orange-600 focus:ring-orange-500 dark:focus:ring-orange-600 shadow-sm">{{ old('me_mtqa_remarks') }}</textarea>
                            @error('me_mtqa_remarks')
